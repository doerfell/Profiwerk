...
to setup-cows
  ...
  create-turtles Kühe-Bäuerin [
    setxy random-xcor random-ycor
    set energy metabolism * 4
      set color red - 1.5
    ifelse Nachhaltigkeit-Bäuerin [
      set breed cooperative-cows][
      set breed greedy-cows]
    ]
  create-turtles Kühe-Bauer [
    setxy random-xcor random-ycor
    set energy metabolism * 4
      set color sky - 2
     ifelse Nachhaltigkeit-Bauer [
      set breed cooperative-cows][
      set breed greedy-cows]
  ]
...
"" ""
PENS
"greedy" 1 0 -14985354 true "" "plot count greedy-cows"
"cooperative" 1 0 -6675684 true "" "plot count cooperative-cows"
